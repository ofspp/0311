<template>
  <div>
    ...
    <el-table :data="check_patient_table" style="width:80%"
      ...
      <el-table-column prop="item_code" label="检查编码" width="180"></el-table-column>
      ...
      <el-table-column prop="check_state" label="状态" width="120"></el-table-column>
      <el-table-column prop="item_type" label="费用分类" width="120"></el-table-column>
    </el-table>
    <el-divider></el-divider>
...
const getCheckPatientTableByRegist = async (registId) => {
  try {
    const resp = await request.get(`/getCheckPatientTableByRegist`, {
